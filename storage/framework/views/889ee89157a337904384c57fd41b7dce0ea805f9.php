...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(URL::asset('css/specification.css')); ?>">
  ...
  <link rel="stylesheet" href="<?php echo e(URL::asset('css/swiper.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::asset('css/indexvgo.css')); ?>">
    ...
    <div class="row">
                ...
                <div class="col-sm-3">
                          ...
                          <div class="info">
                                ...
                                <div class="info-img">
                                    <img class="info-img-top" src="<?php echo e(asset('img/road.jpg')); ?>" alt="image">
                                </div>
                ...
                <div class="col-sm-3">
                          ...
                          <div class="info">
                                ...
                                <div class="info-img">
                                    <img class="info-img-top" src="<?php echo e(asset('img/bike1.jpg')); ?>" alt="image">
                                </div>
          ...
          <div class="col-sm-6 secondCard">
                          ...
                          <div class="info" style="margin-bottom: 40px">
                            ...
                            <div class="info-img" style="height: 180px">
                                <img class="info-img-top" style="height: 180px" src="<?php echo e(asset('img/bike1.jpg')); ?>" alt="image">
                            </div>
                          ...
                          <div class="info">
                            ...
                            <div class="info-img" style="height: 180px">
                                <img class="info-img-top" style="height: 180px" src="<?php echo e(asset('img/insurance.jpg')); ?>" alt="image">
                            </div>

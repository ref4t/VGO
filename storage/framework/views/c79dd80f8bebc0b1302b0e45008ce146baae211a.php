...
<div class="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-4">
                        <div class="logo-small-device">
                            <a href="<?php echo e(route('bikearena.index')); ?>"><img alt=""
                                                                          src="<?php echo e(URL::asset('bikearena/img/logo/logo.png')); ?>"></a>
                        </div>
                    </div>
                            ...
                            <div class="menu-wrapper text-center">
                                <button class="menu-toggle">
                                    <img class="s-open" alt=""
                                         src="<?php echo e(URL::asset('bikearena/img/icon-img/menu.png')); ?>">
                                    <img class="s-close" alt=""
                                         src="<?php echo e(URL::asset('bikearena/img/icon-img/menu-close.png')); ?>">
                                </button>
                                <div class="main-menu">
                                    <nav>
                                        <ul>
                                            <li><a href="<?php echo e(route('bikearena.index')); ?>">home</a></li>
                                            <li class="active"><a href="<?php echo e(route('bikearena.about')); ?>">about us </a>
                                            </li>
                                            <li><a href="#">shop</a>
                                                <ul>
                                                    <li><a href="<?php echo e(route('bikearena.shop')); ?>">shop</a></li>
                                                    <li><a href="<?php echo e(route('bikearena.product-details')); ?>">product
                                                            details</a></li>
                                            ...
                                            <li><a href="#">blog</a>
                                                <ul>
                                                    ...
                                                    <li><a href="<?php echo e(route('bikearena.blog-details')); ?>">blog details</a>
                                                    </li>
                                                </ul>
                                            </li>
                                ...
                                <ul>
                                    <li class="single-shopping-cart">
                                        <div class="shopping-cart-img">
                                            <a href="#"><img alt=""
                                                             src="<?php echo e(URL::asset('bikearena/img/cart/cart-1.jpg')); ?>"></a>
                                        </div>
                                    ...
                                    <li class="single-shopping-cart">
                                        <div class="shopping-cart-img">
                                            <a href="#"><img alt=""
                                                             src="<?php echo e(URL::asset('bikearena/img/cart/cart-2.jpg')); ?>"></a>
                                        </div>
                                        <div class="shopping-cart-title">
                                    ...
                                    <li class="single-shopping-cart">
                                        <div class="shopping-cart-img">
                                            <a href="#"><img alt=""
                                                             src="<?php echo e(URL::asset('bikearena/img/cart/cart-3.jpg')); ?>"></a>
                                        </div>
                                        <div class="shopping-cart-title">
                                            <h3><a href="#">Demonissi Gori</a></h3>
                                            <span>Price: $275</span>
                            ...
                            <nav id="mobile-menu-active">
                                <ul class="menu-overflow">
                                    ...
                                    <li><a href="#">shop</a>
                                        <ul>
                                            <li><a href="<?php echo e(route('bikearena.shop')); ?>">shop</a></li>
                                            <li><a href="<?php echo e(route('bikearena.product-details')); ?>">product details</a>
                                            </li>
                                            <li><a href="<?php echo e(route('bikearena.checkout')); ?>">checkout</a></li>
                                            <li><a href="<?php echo e(route('bikearena.wishlist')); ?>">wishlist</a></li>
                                            <li><a href="<?php echo e(route('bikearena.cart')); ?>">cart</a></li>
    ...
    <div class="breadcrumb-area pt-255 pb-170"
         style="background-image: url(<?php echo e(url('bikearena/img/banner/banner-4.jpg')); ?>)">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="overview-content">
                        ...
                        <p><span>OSWAN</span> the most latgest bike store in the wold can serve you latest qulity of
                            motorcycle also you can sell here your motorcycle it quo minus iduod maxie placeat facere
                            possimus, omnis voluptas assumenda est, omnis dolor llendus. Temporibus autem quibusdam </p>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single-services orange mb-30 text-center">
                        <div class="services-icon">
                            <img alt="" src="<?php echo e(URL::asset('bikearena/img/icon-img/3.png')); ?>">
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-services yellow mb-30 text-center">
                        <div class="services-icon">
                            <img alt="" src="<?php echo e(URL::asset('bikearena/img/icon-img/4.png')); ?>">
                        </div>
                        <div class="services-text">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-services purple mb-30 text-center">
                        <div class="services-icon">
                            <img alt="" src="<?php echo e(URL::asset('bikearena/img/icon-img/5.png')); ?>">
                        </div>
                        <div class="services-text">
                            <h5>MONEY RETURN</h5>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-services sky mb-30 text-center">
                        <div class="services-icon">
                            <img alt="" src="<?php echo e(URL::asset('bikearena/img/icon-img/6.png')); ?>">
                        </div>
                        <div class="services-text">
                            ...
                            <div class="testimonial-content">
                                <div class="testimonial-dec">
                                    <p><span>OSWAN</span> the most latgest bike store in the wold can serve you latest
                                        qulity of motorcycle also you can sell here your motorcycle it quo minus iduod
                                        maxie placeat facere possimus, omnis voluptas assumenda est, omnis dolor
                                        llendus. Temporibus autem quibusdam quoten</p>
                                </div>
                ...
                <div class="single-testimonial">
                    <div class="row">
                        <div class="col-lg-5 col-md-12 col-12">
                            <div class="testimonial-img pl-75">
                                <img alt="image" src="<?php echo e(URL::asset('bikearena/img/team/testimonial-2.jpg')); ?>">
                            </div>
                        </div>
                        <div class="col-lg-7 col-md-12 col-12">
                            <div class="testimonial-content">
                                <div class="testimonial-dec">
                                    <p><span>OSWAN</span> Lorem ipsum dolor sit amet, consectetur adipisicing , sed do
                                        eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
                                        veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex commodo
                                        consequat. Duis dolor in reprehenderit.</p>
                                </div>
                                <div class="name-designation">
    ...
    <div class="team-area pt-120 pb-95">
        <div class="container">
            <div class="section-title text-center mb-60">
                ...
                <p>
                    <span>OSWAN</span>
                    the most latgest bike store in the wold can serve you latest qulity of motorcycle also you can sell
                    here your motorcycle
                </p>
            </div>
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="team-wrapper mb-30">
                        <div class="team-img">
                            <img src="<?php echo e(URL::asset('bikearena/img/team/1.jpg')); ?>" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="team-wrapper mb-30">
                        <div class="team-img">
                            <img src="<?php echo e(URL::asset('bikearena/img/team/2.jpg')); ?>" alt="">
                        </div>
                        <div class="team-content">
                            <h4>Sienna Nguyen</h4>
                            <span>Manager </span>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="team-wrapper mb-30">
                        <div class="team-img">
                            <img src="<?php echo e(URL::asset('bikearena/img/team/3.jpg')); ?>" alt="">
                        </div>
                        <div class="team-content">
                            <h4>Liam Ryan</h4>
                            <span>Director </span>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="team-wrapper mb-30">
                        <div class="team-img">
                            <img src="<?php echo e(URL::asset('bikearena/img/team/4.jpg')); ?>" alt="">
                        </div>
                        <div class="team-content">
                ...
                <div class="row">
                    <div class="col-lg-5 col-12 col-md-12">
                        <div class="newsletter-img bg-img"
                             style="background-image: url(<?php echo e(url('bikearena/img/banner/newsletter-bg.png')); ?>)">
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-about">
                                <p><span>OSWAN</span> the most latgest bike store in the wold can serve you latest ulity

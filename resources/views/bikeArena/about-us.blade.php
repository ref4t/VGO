            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single-services orange mb-30 text-center">
                        <div class="services-icon">
                            <img alt="" src="{{ URL::asset('bikearena/img/icon-img/3.png') }}">
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-services yellow mb-30 text-center">
                        <div class="services-icon">
                            <img alt="" src="{{ URL::asset('bikearena/img/icon-img/4.png') }}">
                        </div>
                        <div class="services-text">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-services purple mb-30 text-center">
                        <div class="services-icon">
                            <img alt="" src="{{ URL::asset('bikearena/img/icon-img/5.png') }}">
                        </div>
                        <div class="services-text">
                            <h5>MONEY RETURN</h5>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-services sky mb-30 text-center">
                        <div class="services-icon">
                            <img alt="" src="{{ URL::asset('bikearena/img/icon-img/6.png') }}">
                        </div>
                        <div class="services-text">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="team-wrapper mb-30">
                        <div class="team-img">
                            <img src="{{ URL::asset('bikearena/img/team/1.jpg') }}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="team-wrapper mb-30">
                        <div class="team-img">
                            <img src="{{ URL::asset('bikearena/img/team/2.jpg') }}" alt="">
                        </div>
                        <div class="team-content">
                            <h4>Sienna Nguyen</h4>
                            <span>Manager </span>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="team-wrapper mb-30">
                        <div class="team-img">
                            <img src="{{ URL::asset('bikearena/img/team/3.jpg') }}" alt="">
                        </div>
                        <div class="team-content">
                            <h4>Liam Ryan</h4>
                            <span>Director </span>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="team-wrapper mb-30">
                        <div class="team-img">
                            <img src="{{ URL::asset('bikearena/img/team/4.jpg') }}" alt="">
                        </div>
                        <div class="team-content">
                ...
                <div class="row">
                    <div class="col-lg-5 col-12 col-md-12">
                        <div class="newsletter-img bg-img"
                             style="background-image: url({{ url('bikearena/img/banner/newsletter-bg.png') }})">

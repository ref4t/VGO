                    ...
                    <div class="product-sidebar-area pr-30">
                        ...
                        <div class="sidebar-widget pb-50">
                            ...
                            <div class="blog-instagram">
                                <ul>
                                    <li><a href="#"><img src="{{ URL::asset('bikearena/img/instagram/instagram1.jpg') }}" alt=""></a></li>
                                    <li><a href="#"><img src="{{ URL::asset('bikearena/img/instagram/instagram2.jpg') }}" alt=""></a></li>
                                    <li><a href="#"><img src="{{ URL::asset('bikearena/img/instagram/instagram3.jpg') }}" alt=""></a></li>
                                    <li><a href="#"><img src="{{ URL::asset('bikearena/img/instagram/instagram4.jpg') }}" alt=""></a></li>
                                    <li><a href="#"><img src="{{ URL::asset('bikearena/img/instagram/instagram5.jpg') }}" alt=""></a></li>
                                    <li><a href="#"><img src="{{ URL::asset('bikearena/img/instagram/instagram6.jpg') }}" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-8">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="blog-hm-wrapper mb-40">
                                <div class="blog-img">
                                    <a href="{{ route('bikearena.blog-details') }}"><img src="{{ URL::asset('bikearena/img/blog/blog-hm-5.jpg') }}" alt="image"></a>
                                    <div class="blog-date">
                                        <h4>24 February, 2018</h4>
                                    </div>
                                    <div class="blog-hm-social">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="blog-hm-wrapper mb-40">
                                <div class="blog-img">
                                    <a href="{{ route('bikearena.blog-details') }}"><img src="{{ URL::asset('bikearena/img/blog/blog-hm-6.jpg') }}" alt="image"></a>
                                    <div class="blog-date">
                                        <h4>22 February, 2018</h4>
                                    </div>
                                    <div class="blog-hm-social">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="blog-hm-wrapper mb-40">
                                <div class="blog-img">
                                    <a href="{{ route('bikearena.blog-details') }}"><img src="{{ URL::asset('bikearena/img/blog/blog-hm-7.jpg') }}" alt="image"></a>
                                    <div class="blog-date">
                                        <h4>20 February, 2018</h4>
                                    </div>
                                    <div class="blog-hm-social">

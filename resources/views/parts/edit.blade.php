            ...
            <div class="panel panel-body col-sm-10">
                <div class="well well-sm">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name" class="form-control" value="{{ $parts->part_name }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="brand" class="col-sm-2 col-form-label lb-lg">Brand Name</label>
                        <div class="col-sm-10">
                            <input type="text" name="brand" class="form-control" value="{{ $parts->part_brand }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="price" class="col-sm-2 col-form-label lb-lg">Description</label>
                        <div class="col-sm-8">
                            <textarea type="text" name="description" class="form-control" rows="5" required>{{ $parts->part_description }}</textarea>
                        </div>
                    </div>
                </div>
